        ...
        <View className='border my-2 border-gray-500 rounded-lg py-2'>
            <View className='gap-3 px-5'>
                <View className='flex-row justify-between items-center'>
                    <Text className='text-black font-semibold text-xl'>{descripcion}</Text>
                    <Text className='text-slate-500 font-semibold text-md'>Cliente: {cliente}</Text>
                </View>
                ...
                {observacion_maquina !== '' &&
                    <View className='border-l border-orange-400 pl-2'>
                        <Text className='font-bold text-orange-600 text-xl'>Observacion</Text>
                        <Text className='text-slate-600 text-lg'>{observacion_maquina}</Text>
                    </View>}

                <View className='gap-16 flex-row  justify-center w-full mt-5'>
                    <Pressable onPress={handlePut} className='border border-gray-500 w-[45%] justify-center gap-2 p-2 rounded-lg flex-row'>
                    ...
                    {isPending ? (
                        ...
                        <Pressable onPress={handleDelete} className='border w-[45%] justify-center gap-2 border-gray-500 p-2 rounded-lg flex-row'>
