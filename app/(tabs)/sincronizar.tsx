...
const Sincronizar = () => {
  return (
    <ScrollView contentContainerClassName="pb-32" className="pt-10 px-2 dark:bg-black h-screen">
      <Text className="text-3xl font-bold mx-2 mt-1 dark:text-white">Sincronizar e Importar</Text>
